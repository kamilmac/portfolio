...
// https://www.youtube.com/watch?v=Qs9A3XIjbg4&t=4s

export default function App({ ...props }) {
  const { nodes, materials } = useSpline('https://prod.spline.design/2fzBhEMomABZT8jc/scene.splinecode')
  return (
    <Canvas
    ...
    >
      ...
      <group {...props} dispose={null}>
        <PerspectiveCamera
          ...
          near={5}
          fov={45}
          position={[1377.41, 805.94, 1621.76]}
        ...
        />
        <group name="Camera1" position={[31.23, 116.79, -76.92]} scale={1.21}>
          ...
          <group name="Right Lens" position={[234.23, 12.63, 143.23]}>
            <mesh
              ...
              scale={0.89}
            />
            <group name="Group 3" position={[-85.15, 81.49, -31.22]} scale={0.89}>
              <mesh
                name="Sphere"
        ...
        <OrthographicCamera
          ...
          far={100000}
          near={-100000}
          position={[1171.5, 827.95, 2041.4]}
          rotation={[-0.41, 0.5, 0.21]}
        />
